...
@Component
public class LotsOfMeatSalesStrategy extends SalesStrategy {
    ...
    public Order applyDiscount(Order order) {
        ...
        BigDecimal hamburgersCount = BigDecimal.valueOf(ingredients
                                                                .size());
        BigDecimal hamburgersToDiscount = hamburgersCount.divide(BigDecimal.valueOf(MIN_TO_HAVE), 2, BigDecimal.ROUND_DOWN);
        BigDecimal valueToDiscount = hamburgersToDiscount.subtract(hamburgersCount.multiply(ingredientValue));
